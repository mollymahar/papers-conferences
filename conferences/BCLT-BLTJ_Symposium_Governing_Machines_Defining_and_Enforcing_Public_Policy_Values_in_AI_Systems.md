...
#### Fairness and/or Privacy & Dignity
...
- Singapore has a governance framework available online [here](www.pdpc.gov.sg/model-ai-gov)
...
#### Lecture by Andrea Jelinek, Chair of the European Data Protection Board
...
- For some purposes, we simply *should not use models and systems for which we cannot explain why we got the answer_. 
